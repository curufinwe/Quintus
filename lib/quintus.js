...
var Quintus = function Quintus(opts) {
  ...
  Q.reset = function(state) { Q.state.reset(state); };
  ...
  Q.setup = function(id, options) {
    ...
    var maxWidth = options.maxWidth || 5000,
        ...
        cssWidth = options.cssWidth || w,
        cssHeight = options.cssHeight || h;
    ...
    if((upsampleWidth && w <= upsampleWidth) ||
      ...
      Q.el.style.height = cssHeight + "px";
      Q.el.style.width = cssWidth + "px";
      Q.el.width = w;
      Q.el.height = h;
    }
    ...
    if(elParent) {
      ...
      Q.wrapper.style.width = cssWidth + "px";
